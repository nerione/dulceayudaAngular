...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter{
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(HttpMethod.GET, "/api/contacts", "/api/contacts/pagina/**", "/images/**", "/api/contacts/file/**").permitAll() //permite mostrar todos los contactos y paginar y ver la foto
